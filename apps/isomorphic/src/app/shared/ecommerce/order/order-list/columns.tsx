...
export const getColumns = ({
  ...
  {
    title: <HeaderCell title="Ürün No" />,
    dataIndex: 'id',
    key: 'id',
    width: 120,
  ...
  {
    title: <HeaderCell title="Ürün İsmi" />,
    dataIndex: 'customer',
    key: 'customer',
    width: 300,
    render: (_: any, row: any) => (
      <TableAvatar src={row.avatar} name={row.name} description={row.detail} />
    ),
  },
  {
    title: (
      <HeaderCell
        title="Son Kullanıcı Fiyatı"
        sortable
        ascending={sortConfig?.direction === 'asc' && sortConfig?.key === 'skf'}
      />
    ),
    onHeaderCell: () => onHeaderCellClick('skf'),
    dataIndex: 'skf',
    key: 'Son Kullanıcı Fiyatı',
    width: 150,
    render: (value: string) => (
...
export const getWidgetColumns = ({
  ...
  {
    title: (
      <HeaderCell title="Ürün No" className="ps-4 [&>div]:whitespace-nowrap" />
    ),
    dataIndex: 'id',
    key: 'id',
    width: 90,
